...
module.exports = class VolumeApiBuilder {
  ...
  buildApis(router) {
    ...
    router.get('/volumes', function(req, res) {
      self.dockerEngineClient.listVolumes().then(function(volumes) {
        apiHelper.handleSuccess(self.eventEmitter, res, "Volumes information lodaded", volumes.Volumes);
      }).catch(e => {
