...
module.exports = class NodeApiBuilder {
  ...
  buildApis(router) {
    ...
    router.get('/nodes', function(req, res) {
      self.dockerEngineClient.listNodes().then(function(nodes) {
        apiHelper.handleSuccess(self.eventEmitter, res, "Nodes information lodaded", nodes);
      }).catch(e => {
