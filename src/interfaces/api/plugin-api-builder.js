...
module.exports = class PluginApiBuilder {
  ...
  buildApis(router) {
    ...
    router.get('/plugins', function(req, res) {
      self.dockerEngineClient.listPlugins().then(function(answer) {
        apiHelper.handleSuccess(self.eventEmitter, res, "Plugins information lodaded", answer);
      }).catch(e => {
