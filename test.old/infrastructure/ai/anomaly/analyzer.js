...
describe('Analizer', function() {
  ...
  it('Validate memory excess rule (issue)', function(done) {
    var container = {
      ...
      "Args":["-jar","/maven/service-resource-management.jar"],
      ...
      "Name":"/zdyynjq4ywfjogiymdmwotmxztfmn2u0_service-resource-management_1",
